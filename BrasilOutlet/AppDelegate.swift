...
//  BrasilOutlet
//
//  Created by Luiz Dias on 10/22/15.
...
//        onboardingVC.bottomPadding = 20
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.brasiloutlet.BrasilOutlet" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("BrasilOutlet", withExtension: "momd")!
